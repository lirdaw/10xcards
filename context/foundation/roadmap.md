...
| H-18 | bug-generation-failed-audit-swallowed | wiedzieć, że nieudany zapis wiersza audytu po awarii generacji nie ginie po cichu — dostaje osobny, wciąż ponawialny komunikat, a właściciel dostaje zgłoszenie do Sentry bez treści użytkownika | MVP (S-01…S-06)  | FR-018 (jasny błąd po awarii generacji), US-01, Guardrails: prywatność          | in progress |
...
- **Status:** in progress — wiersz założony podczas implementacji (p5) razem z doc-syncem, a nie wstecz — praktyka H-15/H-16/H-17; bez niego `/10x-archive` nie ma czego domknąć, a mechanizm „zmiana archiwizuje się bez wiersza i znika z roadmapy" zadziałał w tym projekcie już czterokrotnie (H-04, H-07, H-08, H-13). `/10x-archive` domyka Status na `done`, dopasowując po `Change ID`.
