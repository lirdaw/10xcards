...
| H-19 | bug-signout-swallowed                 | wiedzieć, że wylogowanie NIE poszło i sesja wciąż żyje — zamiast dostać pożegnanie i zostać zalogowanym na wspólnym komputerze                                                                   | MVP (S-01…S-06)  | FR-002 (logowanie i wylogowanie), Guardrails: prywatność per-konto              | in progress |
