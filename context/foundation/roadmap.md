...
| H-20 | bug-middleware-getuser-swallowed      | usłyszeć, że to BACKEND jest chwilowo nieosiągalny — zamiast „Twoja sesja wygasła" nad sesją, która żyje i wróci za chwilę                                                                       | MVP (S-01…S-06)  | FR-002 (logowanie i wylogowanie), NFR: UI po polsku, Guardrails: prywatność     | in progress |
